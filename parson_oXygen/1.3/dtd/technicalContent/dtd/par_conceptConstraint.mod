...
<!--                    HEADER                                     -->
<!-- ============================================================= -->
<!-- MODULE:    parson DITA Concept Constraint Module                   -->
<!--  VERSION:   0.1                                               -->
<!--  DATE:      September 2015                                     -->
<!--  SOURCE VERSION:                                              -->
...
<!-- urn:par:dita:rng:par_conceptConstraintMod.rng                 -->
<!-- ============================================================= -->
...
<!ENTITY par_concept-c-constraints
  "(topic concept par_concept-c)"
>
...
<!-- ================== parson DITA Concept Constraint Module ==================== -->
