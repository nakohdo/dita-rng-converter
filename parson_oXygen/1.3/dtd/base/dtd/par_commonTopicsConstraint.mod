...
<!--                    HEADER                                     -->
<!-- ============================================================= -->
<!--   MODULE:    parson DITA Common Elements, Metadata, and Table Constraint Module for Topics                   -->
<!--   VERSION:   0.2                                              -->
<!--   DATE:      December 2016                                     -->
<!--  SOURCE VERSION:                                              -->
...
<!-- urn:par:dita:rng:par_commonTopicsConstraintMod.rng            -->
<!-- ============================================================= -->
<!-- SYSTEM:     Darwin Information Typing Architecture (DITA)     -->
<!--                                                               -->
<!-- PURPOSE:    Declaring the elements and specialization         -->
<!--             attributes for content elements used in topics,   -->
<!--             as well as meta data and table constraints.                                  -->
<!--                                                               -->
...
<!ENTITY par_commonTopicElements-c-constraints
  "(topic par_commonTopicElements-c)"
>
<!ENTITY % dl                                              "dl">
<!ENTITY % div                                             "div">
<!ENTITY % fig                                             "fig">
...
<!-- ================== parson DITA Common Elements Constraint Module for Topics ==================== -->
